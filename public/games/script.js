        ...
        ctx.drawImage(playerLeft, this.frameX * this.spriteWidth, 
            ...
            */
            ...
            ctx.drawImage(playerRight, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, 
                this.spriteWidth, this.spriteHeight, this.x - 66/ratioDevice, this.y - 68/ratioDevice, this.spriteWidth * 2 / ratioDevice,this.spriteHeight * 2 / ratioDevice);
...
function handleBackground(){
    ...
    ctx.drawImage(salmon, SALMON.frameX * SALMON.spriteWidth, SALMON.frameY * SALMON.spriteHeight, 
        SALMON.spriteWidth, SALMON.spriteHeight, SALMON.width/2, SALMON.height/2, isMobile ? SALMON.spriteWidth/6 : SALMON.spriteWidth/3, isMobile ? SALMON.spriteHeight/6 : SALMON.spriteHeight/3);
