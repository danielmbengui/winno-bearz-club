...
export default function ContainerComponent({ children, about, rarity, collections, roadmap, faq, mint, airdrop, config, links, }) {
  ...
  const updateUserInfo = () => {
    ...
    return(
        <>
          ...
          <Menu pages={{about: about, rarity: rarity, collections: collections, roadmap: roadmap, faq:faq, mint: mint, airdrop:airdrop}}
